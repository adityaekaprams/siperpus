			...
			<table class="table table-bordered">
				...
				<tr>
					<td class="text-rigth" colspan="2">
						...
						<a class="btn btn-secondary btn-lg active" role="button" aria-pressed="true"class="btn btn-primary<?php if($detail['tgl_kembali']!=NULL){echo "disabled";}?>" href="form-kembali.php?id_pinjam=<?=$detail['id_pinjam']?>&id_buku=<?=$detail['id_buku']?>" role="button">Form Pengembalian</a>
					</td>
				</tr>
			</table>
		</div>
